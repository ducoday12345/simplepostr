        ...
        return(
            <Paper className={classes.paper} elevation={6}>
                <Typography variant="h6" align="center">
                    Please Sign In to create your post and interact with other post
                </Typography>
            </Paper>    
        );
    }      
    ...
    return (
        <Paper className={classes.paper} elevation={6}>
            <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
                ...
                <Button class="button-submit" className={classes.buttonSubmit} size = "small" type="submit" role="button" fullWidth>Submit</Button>
                
                {/* <Button variant="contained" color= "secondary" size = "small" onClick={clear} fullWidth>Clear</Button> */}
                <Button class="button-clear"  role="button" size = "small" onClick={clear} fullWidth>Clear</Button>
            </form>
        </Paper>
    );
}
